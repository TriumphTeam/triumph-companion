...
import net.minecraft.server.v1_16_R1.BlockCrops
import net.minecraft.server.v1_16_R1.BlockPosition
import net.minecraft.server.v1_16_R1.BlockSoil
...
class FarmGoal(
    ...
    override fun a(): Boolean {
        ...
        val blockPosList = BlockPosition.MutableBlockPosition(petInsentient.locX(), petInsentient.locY(), petInsentient.locZ())
