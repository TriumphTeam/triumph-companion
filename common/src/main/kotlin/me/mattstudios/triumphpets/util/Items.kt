...
enum class Items(private val item: ItemStack, val texture: String) {
    ...
    CRATE_ITEM_PURPLE_CRACK_SECOND(
            ItemBuilder(XMaterial.PLAYER_HEAD.parseItem())
    ...
    CRATE_ITEM_YELLOW_CRACK_SECOND(
            ItemBuilder(XMaterial.PLAYER_HEAD.parseItem())
