...
object PetProperty : SettingsHolder {
    ...
    val ITEM_SEARCH_DISTANCE: Property<Double> = newProperty("global.item-search-distance", 15.0)
    ...
    val ITEM_TRACK_TICKS: Property<Int> = newProperty("global.item-track-ticks", 20)
    ...
    val ITEM_PICK_DISTANCE: Property<Double> = newProperty("global.item-pick-distance", 1.5)

    @JvmField
    @Comment("After how many seconds without being able to reach an item, the pet should forget about it", "Default: 5")
    val ITEM_FORGET_TIME: Property<Int> = newProperty("global.item-forget-time", 5)

    @JvmField
    @Comment("How often in seconds pet's forget list should be cleared", "Default: 900")
    val FORGET_LIST_TIME: Property<Int> = newProperty("global.forget-list-time", 900)

    @JvmField
    @Comment("Distance in blocks in which the pet should follow player", "Default: 7.0")
    val FOLLOW_DISTANCE: Property<Double> = newProperty("global.follow-distance", 7.0)
